...
filepath = 'C:/Users/Roshan/Desktop/Dataset/Generated Files/Newest/best_model (1).h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/Roshan/Desktop/Dataset/LeafDisease/', filename)
        file.save(file_path)
